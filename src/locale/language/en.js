export default {
  ...
  team : {
    ...
    form : {
      ...
      selectParentPlaceholder : 'Select Parent Team',
      selectFormsPlaceholder : 'Select Forms'
    },
    status : {
      active : 'Active',
      inactive : 'Inactive'
    ...
    message : {
      ...
      pleaseCorrectErrors : 'Please correct the errors before submitting',
      deletionTitle : 'Delete Team',
      deletionConfirmation : 'Are you sure you want to delete the team "{name}"?',
      deletionCanceled : 'Deletion canceled'
    },
    validation : {
      nameRequired : 'Team name is required',
      typeRequired : 'Team type is required',
      leaderRequired : 'Team leader is required',
      parentTeamRequired : 'Parent team selection is required',
