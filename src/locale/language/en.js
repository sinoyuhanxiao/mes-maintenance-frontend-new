export default {
  ...
  workOrder : {
    ...
    placeholder : {
      ...
      selectApprovalTemplate : 'Select approval template',
    ...
    recurrence : {
      ...
      timeRangeTooltip : 'Specifies the time range within each recurrence day for this work order.'
    },
    ...
    messages : {
      ...
      approvalTreeLoadFailed : 'Failed to load approval templates'
    },
    ...
    validation : {
      ...
      assetRequired : 'Please select equipment',
