<template>
  <div class="template-library-view">
...
<!--            </el-select>-->
            ...
            >
              <el-option v-for="a in availableAssets" :key="a" :label="a" :value="a" />
            </el-select>
              ...
              <div class="overview-card">
                <div class="card-content">
                  <el-descriptions :column="3" direction="vertical">
                    ...
                    <el-descriptions-item label="Category">{{ selectedTemplate.category || 'Uncategorized' }}</el-descriptions-item>
                    <el-descriptions-item label="Asset/Equipment">{{ selectedTemplate.asset || 'No asset specified' }}</el-descriptions-item>
                    <el-descriptions-item width='33%' label="Estimated Time">
                      <span class="info-value highlight">
                        {{ selectedTemplate.estimated_minutes ? `${selectedTemplate.estimated_minutes} minutes` : 'Not specified' }}
                      </span>
                    </el-descriptions-item>
                    ...
                    <el-descriptions-item label="Created On">{{ formatDate(selectedTemplate.created_at) }}</el-descriptions-item>
                    <el-descriptions-item label="Last Modified">{{ formatDate(selectedTemplate.updated_at) }}</el-descriptions-item>
                  </el-descriptions>
                </div>
              </div>
    ...
    <el-dialog :model-value="deleteDialogVisible" @update:model-value="(val) => deleteDialogVisible = val" title="Delete Task" width="400px" :before-close="handleDeleteCancel">
...
import { Search, Plus, Edit, Delete, Check, DocumentCopy, MoreFilled, Lightning, Monitor, Location, UserFilled, CircleCheck, Calendar, Document } from '@element-plus/icons-vue'
