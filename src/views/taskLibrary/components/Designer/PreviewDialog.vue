    ...
    <div class="preview-content">
      ...
      <div class="preview-toolbar" v-if="showToolbar">
        <div class="toolbar-left">
          <el-button
            v-if="toolbarConfig.showStepNumbersToggle"
            type="text"
            size="small"
            @click="toggleStepNumbers"
          >
      ...
      >
        <!-- Sections -->
        <div
          v-for="section in renderSnapshot.sections"
          ...
          <div v-if="section.expanded" class="section-content">
            ...
            >
              ...
              <div class="step-content">
                ...
                <!-- Step Meta -->
                <div v-if="step.ui.relevant_tools?.length > 0 || step.ui.relevant_resources?.length > 0" class="step-options">
                  <div class="step-meta">
                    <el-button
...
import {
  List, Monitor, Iphone, ArrowDown, ArrowRight,
  Printer, Tools, Folder
...
const props = defineProps({
  ...
  // Configuration objects based on JSON schema
  dialogConfig: {
    type: Object,
    default: () => ({
...
const showToolbar = computed(() => {
  return props.toolbarConfig.showStepNumbersToggle ||
         props.toolbarConfig.showViewportSwitcher
})
...
watch(() => props.layoutConfig.sectionsInitiallyExpanded, (expanded) => {
...
watch(() => renderSnapshot.value.sections, (sections) => {
