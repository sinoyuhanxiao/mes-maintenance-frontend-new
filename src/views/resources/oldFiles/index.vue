...
import ViewDetails from '@/views/resources/oldFiles/ViewDetails.vue'
import Batches from '@/views/resources/oldFiles/Batches/Batches.vue'
import Usage from '@/views/resources/oldFiles/Usage.vue'
import Transactions from '@/views/resources/oldFiles/Transactions.vue'
import History from '@/views/resources/oldFiles/History.vue'
import ToolsView from '@/views/resources/components/tools/ToolsView.vue'
import CardTable from '@/components/Tables/CardTable.vue'
import SparePartForm from '@/views/resources/oldFiles/SparePartForm.vue'
