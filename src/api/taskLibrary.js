    ...
    data : [
      {
        ...
        description : 'Conduct monthly preventive maintenance on freezer equipment to ensure reliable operation and food safety. Tasks include inspecting electrical connections, cleaning coils and filters, checking compressor performance, verifying thermostat accuracy, and documenting any issues.',
      ...
      },
      {
        ...
        description : 'Carry out a weekly routine inspection of equipment to check for proper operation, cleanliness, safety compliance, and early signs of wear or malfunction.',
        category : 'Inspection',
        asset : 'Freezer',
        version : { major : 1, minor : 0 },
...
export const getTemplate = async id => {
  ...
  // Return sample template from our JSON schema
  return {
    data : {
      template_id : id,
      name : 'Monthly Freezer PM',
...
export const getAvailableTools = async() => {
  ...
  return {
    data : [
      { tool_id : 't-001', name : 'Flashlight', spec : 'LED Flashlight' },
      { tool_id : 't-002', name : 'Thermometer', spec : 'Digital -50°C to 150°C' },
      { tool_id : 't-003', name : 'Multimeter', spec : 'Digital Multimeter' },
      { tool_id : 't-004', name : 'Screwdriver Set', spec : 'Phillips and Flathead' },
      { tool_id : 't-005', name : 'Wrench Set', spec : 'Adjustable Wrench Set' }
    ]
  }
}
